...
**Reseller** - пользователь, являющийся реселлером наших купонов и сертефикатов. Имеет доступ к информации по текущим акциям в городах и покупке купонов.

Примером использования Reseller API могут являться интернет-витрины, перепродающие купоны и сертефикаты.
